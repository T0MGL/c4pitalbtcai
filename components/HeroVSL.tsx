    ...
    <section id="hero-section" className="relative min-h-screen flex flex-col items-center justify-center pt-32 pb-20 lg:pt-44 lg:pb-32 overflow-hidden bg-brand-dark">
      ...
      >
        ...
        <div className="flex flex-col items-center animate-fade-in-up" style={{ animationDelay: '1.2s' }}>
          ...
          <a href="https://www.myfxbook.com/members/GoldenForexx/capitalbtc-ai-trader/11726357" target="_blank" rel="noopener noreferrer" className="mt-6 inline-flex items-center gap-2 text-brand-gold text-xs font-bold uppercase tracking-widest hover:text-white transition-colors group">
