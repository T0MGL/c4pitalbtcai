                        ...
                        {step === 5 && (
                            <div className="space-y-6 animate-fade-in-up">
                                ...
                                <div className="pt-2">
                                    ...
                                    <a
                                        href="https://wa.me/595983912902?text=Tengo%20capital%20para%20iniciar%2C%20necesito%20prioridad%20con%20mi%20licencia."
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="group flex items-center justify-center gap-2 w-full mt-4 py-3 rounded-xl border border-emerald-500/30 bg-emerald-500/5 hover:bg-emerald-500/15 hover:border-emerald-500/50 transition-all duration-300"
                                    >
