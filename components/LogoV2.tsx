    ...
    <div className="flex items-center gap-3">
      ...
      >
        <defs>
          ...
          <linearGradient id="logo-v2-trend" x1="0%" y1="100%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#B38B3A" />
        ...
        {/* Ascending Trend Line - Growth / Capital gains */}
        <path
          d="M 54 60 L 64 46 L 76 34"
          stroke="url(#logo-v2-trend)"
          strokeWidth="4"
          strokeLinecap="round"
          strokeLinejoin="round"
          fill="none"
        ...
        {/* Peak Node - Summit / target */}
        <circle
          cx="76" cy="34" r="4.5"
          fill="#F5E6C8"
          filter="drop-shadow(0 0 4px rgba(245, 230, 200, 0.5))"
        />
      </svg>
