...
export const QualificationForm: React.FC = () => {
    ...
    const TELEGRAM_CHANNEL = 'https://t.me/Capitalbtcai';
                            ...
                            <div className="text-center animate-fade-in-up">
                                ...
                                <div className="bg-white/5 rounded-xl p-4 border border-white/10 mb-8">
                                    <p className="text-slate-300 text-sm leading-relaxed">
                                        ...
                                        <span className="text-brand-gold font-bold">Únete a nuestro canal de Telegram</span> para recibir señales y la confirmación de tu acceso.
                                    </p>
                                </div>
                                <a
                                    href="https://t.me/Capitalbtcai"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="group flex items-center justify-center gap-2 w-full py-3.5 rounded-xl border border-sky-500/30 bg-sky-500/5 hover:bg-sky-500/15 hover:border-sky-500/50 transition-all duration-300 mb-3"
                                >
                                    ...
                                    <span className="text-xs font-medium text-sky-400 group-hover:text-sky-300 transition-colors">
                                ...
                                <div className="mb-6 flex justify-between items-end border-b border-white/5 pb-4">
                                    <div>
                                        ...
                                        <h2 className="text-xl md:text-2xl font-serif font-bold text-white leading-tight">
                                            {step === 5 ? "Datos de contacto" : (dynamicHeader || "¿Qué te impide lograr rentabilidad hoy?")}
                                        </h2>
                                    </div>
                                </div>
                                ...
                                {step === 6 && (
                                    <div className="space-y-6 animate-fade-in-up">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="space-y-1">
                                                <label className="text-xs text-slate-500 font-bold ml-1 uppercase">Tu número de teléfono</label>
                                        ...
                                        <div className="pt-2">
                                            ...
                                            <p className="text-[10px] text-center text-slate-600 mt-4">
                                                Al enviar aceptas ser contactado para la entrega de accesos.
                                            </p>
                                        </div>
                                    </div>
                                )}
